...
class JSONImporter:
    ...
    def convert(self, data: Union[Dict, List, Any], clear_db: bool = False, root_label: str = "Root") -> None:
        """
        ...
        self._process_value(data, parent_node_id=None, relationship_name=root_label, key_name=root_label)
    ...
    def _process_array(self, arr: List, parent_node_id: Optional[str], 
                      relationship_name: str, key_name: str) -> str:
        """
    ...
    def _format_properties(self, properties: Dict[str, Any]) -> str:
        ...
        for key, value in properties.items():
            ...
            if isinstance(value, list):
                ...
                props.append(f"{sanitized_key}: {value}")
            elif value is None:
