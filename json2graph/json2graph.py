...
class JSONImporter:
    ...
    def convert(
        ...
        self._process_value(
            data, parent_node_id=None, relationship_name=root_label, key_name=root_label
        )
    ...
    def _process_value(
        ...
        if value is None:
            ...
            if parent_node_id is None:
                properties = {
                    "value": None,
                    "_hash": self._generate_hash({"Null": None}),
                }
        ...
        if isinstance(value, dict):
            ...
            return self._process_object(
                value, parent_node_id, relationship_name, key_name
            )
    ...
    def _process_array(
        ...
        properties = {"length": len(arr), "_hash": self._generate_hash({label: arr})}
